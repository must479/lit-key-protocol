...
import { ContextWithLit, DIDMethodNameWithLit, DIDProviderMethodsWithLit, DIDProviderWithLit, IPFSData, encodeDIDWithLitParam, EcdsaSignature } from "./interfaces.js";
